...
Present the following structured output and ask: "确认写入文件？" Wait for an affirmative reply before proceeding.
...
If `changelog.md` does not exist, create it with this entry as the first record.
